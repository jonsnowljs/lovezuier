...
function go () {
  typish('#typer')
    ...
    .type('今天发条橙先生教你写代码呀', '<span class="note">')
    .type('0', '<br>')
    .type('00', '<span class="blank">')
    .wait(10)
    .type('等一下下哦', '<span class="note">')
    .wait(10)
    .type('(。•ω•。)ﾉ♡', '<span class="note">', 0)
    .wait(10)
    .then(() => {
      memeda()
    })
